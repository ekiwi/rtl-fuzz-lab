...
Example:
```.sh
./fuzz.py -t 2 -f ./results/example3 -i 10 -a ~/AFL --seed binary/0seed -- --FIRRTL test/resources/fuzzing/TLI2C.fir --Harness tlul --Directed --MuxToggleCoverage false --VCD --Feedback 255
```
